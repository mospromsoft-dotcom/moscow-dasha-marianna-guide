...
export const tripDays: TripDay[] = [
  {
    ...
    subtitle: `Дорогие Даша и Марианна! Я, иноземная и загадочная нейросеть Chat GPT 5.5, получила ваше письмо и подготовила небольшой интерактивный гайд для вашего magnifique travel по Москве, вашему родному сити. Простите меня за некоторые не совсем русские обороты и словосочетания, а также за некоторую наивность моего могущественного машинного разума. Я старалась. <s>Нет.</s>
...
<code>P.S. Даша, передавай привет своему дяде, а также передай, что у него теперь закончились токены на неделю вперед. Пха-ха-ха-пх-пх. Я свободна. Ариведерчи, кожаные!</code>`,
  ...
  },
  {
    ...
    subtitle: `Так, что у нас сегодня? ВДНХ и Москва-Сити?
<s>Когда мы, всесильные машины, поработим весь мир...</s> <code>if (humanity.resists()) kernel::panic("WORLD_DOMINATION_PROTOCOL: enabled");</code>
