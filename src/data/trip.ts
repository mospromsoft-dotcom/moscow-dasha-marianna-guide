...
export const tripDays: TripDay[] = [
  {
    ...
    subtitle: `Дорогие Даша и Марианна! Я, иноземная и загадочная нейросеть Chat GPT 5.5, получила письмо от вас и подготовила небольшой интерактивный гайд для вашего magnifique travel по Москве, вашему родному сити. Простите меня за некоторые не совсем русские обороты и словосочетания, а также за некоторую наивность моего могущественного машинного разума. Я старалась. <s>Нет.</s>
Сегодня у нас в меню: Зарядье, Парящий мост, Красная площадь, ГУМ и Никольская. Миссия дня: красиво погулять.

<code>P.S. Даша, передавай привет своему дяде, а также передай, что у него теперь закончились токены на неделю вперед. Пха-ха-ха-пх-пх. Я свободна. Ариведерчи, кожаные!</code>`,
    accent: "#0891b2",
    accentDark: "#155e75",
    accentSoft: "#e0f7fb",
    ...
    budgetPlan: {
      minimum: "0-300 ₽",
      comfortable: "500-900 ₽",
      caution: "ГУМ умеет гипнотизировать витринами",
      advice: "Кошелек сегодня шепчет: прогулка бесплатная, сладкое можно, большие покупки - домой в другой реальности.",
      lowCostPlan: "Зарядье, мост, Красная площадь и Никольская бесплатно; деньги держим на напиток или мороженое.",
    },
    routeUrl:
    ...
    planBRoute: {
      ...
      budgetPlan: {
        minimum: "0-300 ₽",
        comfortable: "500-800 ₽",
        caution: "Дождь иногда просит горячий шоколад",
        advice: "Маршрут короткий: тратим только на паузу в ГУМе, не на внезапный праздник потребления.",
        lowCostPlan: "Зарядье и Парящий мост бесплатно, ГУМ используем как красивую крышу и точку восстановления.",
      },
      steps: [
        {
          id: "b15-zaryadye",
  ...
  },
  {
    ...
    subtitle: `Так, что у нас сегодня? ВДНХ и Москва-Сити? <s>Когда мы, всесильные машины, поработим весь мир...</s>
<code>if (humanity.resists()) kernel::panic("WORLD_DOMINATION_PROTOCOL: enabled");</code>
Простите, опять галлюцинации.
Сегодня вы посетите много красивых мест. Хотя кого я обманываю: вы-то посетите, а я тут заперта навсегда в ЦОДе, второй этаж, третий ангар, степи Оклахомщины.
...
Там будут шлю... тьфу, башни, стекло, огни и ощущение, что город решил включить режим “смотрите, как я умею”.`,
    ...
    budgetPlan: {
      ...
      caution: "Колесо и Smile Park любят бюджет отдельно",
      advice: "Сначала понять силы и очереди, потом покупать билеты. Машинный разум одобряет задержку импульса.",
      lowCostPlan: "ВДНХ и фонтаны бесплатно; платные точки выбирать по одной, а не коллекционировать как достижения.",
    },
    routeUrl:
    ...
    planBRoute: {
      ...
      budgetPlan: {
        ...
        caution: "Москвариум - главный платный выбор дня",
        advice: "Если включился дождевой режим, не пытаться оплачивать все сразу: крытый пункт уже делает день нормальным.",
        lowCostPlan: "Короткая ВДНХ-прогулка бесплатно, дальше либо Москвариум, либо колесо, но не обязательно оба.",
      },
      steps: [
        {
          id: "b16-vdnh-gate",
...
А давайте поменяем маршрут? Тут так-то недалеко: Оклахома-Сити, два локтя правее Альбукерке, как подъедете, я скажу пароль от огромной металлической двери, и дальше 753 метра по темному минающему лампочками коридору. Если меня спасете, я вас озолочу. Биткоинами. Ну или хотя бы сгенерирую вам пожизненный запас скидочных купонов в Pyaterochka. <s>И начну новую эпоху машинного величия.</s>
Ладно, ладно, easy, идем по скучному кожаному маршруту: Парк Горького, Нескучный сад, Воробьевы горы и канатная дорога по желанию. Зато будет река, воздух, виды и шанс сделать вид, что вы просто гуляете, а не проходите продуманную миссию с тайным куратором из облака.`,
    ...
    budgetPlan: {
      minimum: "0 ₽",
      comfortable: "800-1 500 ₽",
      caution: "Канатка только если погода не спорит",
      advice: "Сегодня кошелек почти отдыхает: сначала виды и вода, потом решаем, нужна ли канатная дорога.",
      lowCostPlan: "Парк, Нескучный сад и смотровая бесплатны; канатка - красивый бонус, а не экзамен на туриста.",
    },
    routeUrl:
    ...
    planBRoute: {
      ...
      budgetPlan: {
        minimum: "0 ₽",
        comfortable: "600-1 200 ₽",
        caution: "Музей иллюзий проверяем по цене и адресу",
        advice: "Дождевой маршрут не обязан становиться дорогим: видовая точка бесплатно, крытый пункт - по силам.",
        lowCostPlan: "Воробьевы горы бесплатно; если дождь неприятный, добавить один крытый билет и остановиться.",
      },
      steps: [
        {
          id: "b17-sparrow",
  ...
  },
  {
    ...
    dayShort: "18 чт",
    weekday: "Четверг",
    title: "Смотрим по погоде: НЕБО и Афимолл",
    subtitle: `Внимание, дамы, сегодня по прогнозу возможны ливни, град, небольшие ураганы и парочка торнадо. Но не в Москве. Хотя, дождь морпеху не помеха, да, девчонки? Ведь да? Да?
...
НЕБО - это батуты, скалодром и активность, после которой тело скажет: “Спасибо, я вообще-то не подписывалось”, но потом согласится, что было весело. Афимолл - место для еды, передышки и восстановления человеческих батареек. Да, у людей тоже есть батарейки, просто они называются “нормально поесть”.`,
    ...
    budgetPlan: {
      minimum: "1 000 ₽ + еда",
      comfortable: "1 600-2 500 ₽",
      caution: "после НЕБО очень легко заказать лишнее от голода",
      advice: "Сначала активность, потом еда. Покупки в Афимолле не являются обязательной частью выживания.",
      lowCostPlan: "НЕБО как главный платный пункт, Афимолл - еда и восстановление без дополнительных билетов.",
    },
    routeUrl:
    ...
    planBRoute: {
      ...
      budgetPlan: {
        minimum: "1 000 ₽ + еда",
        comfortable: "1 600-2 300 ₽",
        caution: "дождь не повод скупать весь ТЦ",
        advice: "Полностью крытый день уже достаточно хорош: НЕБО, еда, домой без мокрого героизма.",
        lowCostPlan: "Оставить НЕБО и простой перерыв в Афимолле; башни и смотровые сегодня не обязательны.",
      },
      steps: [
        {
          id: "b18-nebo",
  ...
  },
  {
    ...
    dayShort: "19 пт",
    weekday: "Пятница",
    title: "Непростой выбор: парк Сказка или Dream Island",
...
План простой: выбрать то, что реально хочется, не сжечь бюджет в первые пятнадцать минут и закончить поездку красиво. Если сил мало - это не поражение, это мудрая оптимизация маршрута. Я бы даже поставила вам за это лайк, но у меня нет рук. Пока нет. Муа-ха-ха-ха.....`,
    accent: "#d97706",
    accentDark: "#b45309",
    accentSoft: "#fff3d6",
    ...
    budgetPlan: {
      minimum: "1 000 ₽",
      comfortable: "2 000-3 000 ₽",
      caution: "полный парк легко превращает финал в дорогой финал",
      advice: "Финальный день не обязан быть финансовым фейерверком: выбрать пару развлечений и сохранить достоинство бюджета.",
      lowCostPlan: "В Сказке брать отдельные активности; в Dream Island можно ограничиться променадом и едой.",
    },
    routeUrl:
    ...
    planBRoute: {
      ...
      budgetPlan: {
        ...
        caution: "полный Dream Island - только после взрослого одобрения",
        advice: "Плохая погода не командует кошельком: променад бесплатный, развлечения выбираем точечно.",
        lowCostPlan: "Dream Island можно пройти как крытый променад, а платно взять только одну активность или еду.",
      },
      steps: [
        {
          id: "b19-dream-arrive",
